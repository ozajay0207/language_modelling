...
for w1_w2 in model:    
	...
	temp=(w3,)
	for w3 in model[w1_w2]:
		model_interpolation[w1_w2][w3] = (lambda_1 * model[w1_w2][w3]) + (lambda_2 * model1[w2][w3]) + (lambda_3 *model2[temp])	
...
f1 = open("output_testing_new_final.txt","w")
