...
test1="reece and India. The word 'atom' was coined by ancient Greek philosophers. However, these ideas were founded in philosophical and theological reasoning rather than evidence and experimentation."

test="Zipf's law is an empirical law formulated using mathematical statistics.Greece and India. The word 'atom' was coined by ancient Greek philosophers. However, these ideas were founded in philosophical and theological reasoning rather than evidence and"
...
print("\nTokenizing ...")
word_tokenized_string = word_tokenize(test1)
